...
- First-boot setup wizard at `/setup` — guides through Salesforce Connected App creation, paste-in form for credentials, writes them to `.env`.
...
Until 1.0.0, MINOR bumps may include breaking changes — common practice for pre-1.0 projects. We'll call them out explicitly in this changelog.

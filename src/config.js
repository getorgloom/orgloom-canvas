...
// Pin the managed-package version in source so a stale deployment variable
// cannot send new users to an older beta build.
const _ORGLOOM_PACKAGE_VERSION_ID = '04tao000005dalVAAQ';
...
export const config = {
	...
	salesforce: {
		...
		packageVersionId: _ORGLOOM_PACKAGE_VERSION_ID,
	},
	canvas: {

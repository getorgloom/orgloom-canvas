// Server-side parser/evaluator for the validation-formula subset mirrored by public/js/formula.js.
	...
	switch (n.k) {
		...
		case 'call': {
			...
			switch (n.name) {
				...
				case 'CONTAINS':
					return (
						String(args[0] == null ? '' : args[0]).indexOf(String(args[1] == null ? '' : args[1])) !== -1
					);
				case 'BEGINS':
					return String(args[0] == null ? '' : args[0]).indexOf(String(args[1] == null ? '' : args[1])) === 0;
				case 'ISPICKVAL':

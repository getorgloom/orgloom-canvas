		...
		for (let ci = 0; ci < contactCount; ci++) {
			...
			CONTACTS.push({
				...
				Email:
					...
					'@' +
					account.Name.toLowerCase().replace(/[^a-z0-9]+/g, '') +
					'.demo',
				Phone:
					'(555) ' +
					String(200 + contactIdx).padStart(3, '0') +
					'-' +
					String(2000 + contactIdx).padStart(4, '0'),
				MobilePhone:
					'(555) ' +
					String(400 + contactIdx).padStart(3, '0') +
					'-' +
					String(4000 + contactIdx).padStart(4, '0'),
				Title: pick(

...
function mountSlotUser(currentCanvas, sfUserId = '005OWNER') {
...
test('recipient assignment locks still apply to the wrong teammate', () => {
	const api = mountSlotUser({ id: '069CANVAS', ownedByMe: false });
	...
	const assignedApi = mountSlotUser({ id: '069CANVAS', ownedByMe: false }, '005ASSIGNEE');
